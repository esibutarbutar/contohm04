import 'package:app1/pagedua.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  var _namaKegiatan = TextEditingController();
  var _keteranganKegiatan = TextEditingController();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Todos - 211112007 - Bayu Arma Praja'),
      ),
      body: Center(
        child: SizedBox(
          width: 440,
